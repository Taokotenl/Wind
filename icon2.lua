...
-- Utility: Decompile function (Safe version)
local function DecompileFunction(func, funcName)
    ...
    if success and next(upvalues) then
    ...
    table.insert(lines, "    -- Check the original Rayfield script for the actual implementation")
